...
NOTE: Microservice do not make a system cloud native & Cloud native does not Require microservices  
      Utilizing Microservices in a Cloud Native pattern is the key  
      Cloud native can run anywhere not just in the cloud  

### Cloud Native  
- is an architectural style  
- designed to facilitate operating in the cloud  
- includes things like externalizing configuration, making your application startup fast, handle immediate shutdowns gracefully  
- cloud native 12 factor application development  
- focused on portable and scalable applications  
...
- Using Cache to bridge outages  
- Avoid tight coupling usin Queues  
